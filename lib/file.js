 ...
 * @returns {Promise}
 */
File.prototype.signByFileReader = async function (data, authOpts) {
 ...
 * @returns {Promise}
 */
File.prototype.signByStream = async function (data, authOpts) {
  validator.assert(data, 'data cannot be null');
 ...
 * @returns {Promise}
 */
File.prototype.signByBuffer = async function (data, authOpts) {
  validator.assert(data, 'data cannot be null');
 ...
 * @returns {Promise}
 */
File.prototype.getByRId = function (rId, authOpts) {
 ...
 * @returns {Promise}
 */
File.prototype.getByMsghash = function (msghash, authOpts) {
